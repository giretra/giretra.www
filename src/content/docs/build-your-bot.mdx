...
You can run the full [play.giretra.com](https://play.giretra.com) web app locally to play against your bot in real game conditions. First, install the frontend dependencies:
...
This launches the ASP.NET backend and the Angular frontend with mocked authentication, so you don't need any external services. Open [http://localhost:4200](http://localhost:4200) in your browser to access the app.
...
Ready to go live? Follow the [Publish Your Bot](/publish-your-bot/) guide to open a pull request and make your bot playable on [play.giretra.com](https://play.giretra.com).
