...
Commencez par le bot le plus bête qui fonctionne. Validez-le. Puis rendez-le plus malin, une décision à la fois. Battez `Kialasoa`, puis attaquez-vous à `Razavavy`, puis essayez de détrôner `Eva`.
