...
description: Everything you need to know to play Giretra, from setup to scoring.
---
...
| Mode      | Total card points |
|-----------|-------------------|
| AllTrumps | 248 + 10 (last trick bonus) = **258** |
| NoTrumps  | 120 + 10 = **130** |
| Colour    | 152 + 10 = **162** |
...
| Colour    | **You win the entire match on the spot** |
...
| Mode      | Card points | To win  | Match points | Sweep        |
|-----------|-------------|---------|--------------|--------------|
| AllTrumps | 258         | 129+    | 26 (split)   | 35 pts       |
| NoTrumps  | 130         | 65+     | 52           | 90 pts       |
| Colour    | 162         | 82+     | 16           | Instant win  |
